...
ALTER TABLE tenants ADD COLUMN IF NOT EXISTS ciclo_suscripcion TEXT NOT NULL DEFAULT 'Mensual';
ALTER TABLE tenants ADD COLUMN IF NOT EXISTS time_zone_id TEXT NOT NULL DEFAULT 'America/Bogota';
